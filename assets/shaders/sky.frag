...
void main()
{
	...
	vec4 pixel_world_pos = PV * vec4(texCoord * 2.0 - 1.0, 1.0, 1.0);
	...
	vec3 dir = normalize(pixel_world_pos.xyz - CAMERA_POSITION);
	...
	fragmentColor = MULTIPLIER * texture(environmentMap, lookup);
}
